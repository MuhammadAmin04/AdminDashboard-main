  ...
  return (
    <section className="bg-[#D9ECFF]">
      <div className="container">
        ...
        <div className="flex">
          <div className="card2 w-[253px] h-[326px]  inline-block items-center justify-center border mx-auto rounded-[20px] shadow-md bg-white mb-[155px]d hover:shadow-xl">
            <img
              src={img1}
              alt="img"
